          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>info@serranidjourneys.com</span>
              </div>
            </div>
          </div>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gradient-hero transition-all duration-200 group"
                    aria-label={social.label}
                  >
                    <social.icon className="h-5 w-5 text-white/80 group-hover:text-white" />
                  </a>
                ))}
              </div>
            </div>
