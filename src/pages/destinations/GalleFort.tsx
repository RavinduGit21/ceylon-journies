import { ArrowLeft, MapPin, Star, Shield, Camera, Building, Clock, ThermometerSun } from 'lucide-react';
...
// Import Galle Fort images
import galleFortHero from '@/assets/galle-fort.jpg';
import galleFort1 from '@/assets/galle-fort1.jpg';

const GalleFort = () => {
  const experiences = [
    {
      icon: Shield,
      title: "Historic Ramparts",
      description: "Walk along the 400-year-old Dutch fortifications that have withstood centuries of ocean storms and colonial conquests.",
      image: galleFortHero,
      stats: { duration: "2-3 Hours", difficulty: "Easy", built: "1588 AD" }
    },
    {
      icon: Building,
      title: "Colonial Architecture",
      description: "Discover perfectly preserved Dutch colonial buildings, churches, and museums within the fortress walls.",
      image: galleFort1,
      stats: { duration: "Half Day", difficulty: "Easy", heritage: "UNESCO" }
    },
    {
      icon: Camera,
      title: "Sunset Views",
      description: "Experience breathtaking sunsets over the Indian Ocean from the historic lighthouse and rampart walls.",
      image: galleFortHero,
      stats: { duration: "1-2 Hours", difficulty: "Easy", elevation: "10m" }
    }
  ];

  const quickFacts = [
    { icon: ThermometerSun, label: "Climate", value: "26-30°C Year Round" },
    { icon: MapPin, label: "Built", value: "16th Century" },
    { icon: Clock, label: "Best Time", value: "Nov - Apr" },
    { icon: Shield, label: "From Colombo", value: "2 hours" }
  ];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 animate-fade-in">
          ...
          <p className="text-xl sm:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
            Where colonial history meets the endless ocean, and every cobblestone tells a story 
            of maritime adventures and architectural mastery
          </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Step into living history where Dutch colonial heritage meets tropical paradise
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-3xl sm:text-4xl font-display font-bold text-foreground mb-6">
              Begin Your Galle Fort Journey
            </h3>
            <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
              Walk through centuries of history where every stone has witnessed the rise and fall of empires, 
              and the ocean continues its eternal dance with the fortress walls.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-ocean text-white hover:opacity-90 transition-opacity">
                <Shield className="h-5 w-5 mr-2" />
                Plan My Historic Tour
              </Button>
